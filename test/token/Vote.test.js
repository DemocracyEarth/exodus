...
contract('Vote', function ([_, testAddress, owner, recipient, anotherAccount]) {
  ...
  beforeEach(async function () {
    this.app = await TestHelper({ from: testAddress });
    this.proxy = await this.app.createProxy(Vote, 'Vote', 'initialize', [owner]);
    // this.proxy = await this.app.createProxy(Vote);
  });
  ...
  describe('balanceOf', function () {
    describe('when the requested account has no tokens', function () {
      it('returns zero', async function () {
        const balance = await this.proxy.balanceOf(anotherAccount);
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the sender has enough balance', function () {
        ...
        it('transfers the requested amount', async function () {
          ...
          const senderBalance = await this.proxy.balanceOf(owner);
          assert.equal(senderBalance, 0);

          const recipientBalance = await this.proxy.balanceOf(to);
      ...
      describe('when the sender has enough balance', function () {
        ...
        describe('when there was no approved amount before', function () {
          it('approves the requested amount', async function () {
            ...
            const allowance = await this.proxy.allowance(owner, spender);
  ...
  describe('transfer from', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        beforeEach(async function () {
          await this.proxy.approve(spender, 100000000, { from: owner });
        });
      ...
      describe('when the sender has enough balance', function () {
        ...
        describe('when there was no approved amount before', function () {
          it('keeps the allowance to zero', async function () {
            await this.proxy.decreaseApproval(spender, amount, { from: owner });
        ...
        describe('when the spender had an approved amount', function () {
          beforeEach(async function () {
            await this.proxy.approve(spender, amount + 1, { from: owner });
          });
