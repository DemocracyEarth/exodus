...
const CappedCrowdsale = artifacts.require('SimpleCappedCrowdsale');
const SimpleToken = artifacts.require('SimpleVote');

contract('CappedCrowdsale', function ([_, wallet, purchaser]) {
  ...
  context('with crowdsale', function () {
    ...
    describe('accepting payments', function () {
      it('should accept payments within cap', async function () {
        await this.crowdsale.send(cap.minus(lessThanCap), { gas: 1000000, from: purchaser });
